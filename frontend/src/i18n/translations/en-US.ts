export default {
  ...
  // /upload
  "upload.title": "Upload",
  "upload.mode.file": "File share",
  "upload.mode.text": "Text share",
  "upload.text.label": "Text",
  "upload.text.placeholder": "Paste or type the text you want to share.",
  ...
  "upload.modal.completed.passcode": "Passcode",
  ...
  "share.text.title": "Shared text",
  "share.text.copy": "Copy text",
  ...
  // /code
  "passcode.title": "Open with passcode",
  "passcode.description": "Enter a share passcode to open the matching share.",
  "passcode.input.label": "Passcode",
  "passcode.input.placeholder": "Enter passcode",
  "passcode.button.open": "Open share",
  "passcode.error.invalid": "We could not find a share for that passcode.",
  "passcode.error.missing": "Enter a passcode to continue.",
  // END /code
